...
const STATS = [
  ...
  { value: '3', label: 'Projects', sub: 'Shipped & working' },
  { value: '1st', label: 'Place', sub: 'Web Competition 2024' },
  { value: '🇲🇾', label: 'Exchange', sub: 'Politeknik Mersing' },
];
      ...
      <div className="container hero__inner">
        ...
        <div className="hero__content">
          ...
          <div className="hero__status anim-1">
            ...
            Open to SE Internships · 2025
          </div>

          {/* Name */}
          <h1 className="hero__name anim-2">
            Muhammad<br />Juna Nasri
          </h1>
          ...
          <div className="hero__ctas anim-5">
            ...
            <a href="/CV_Muhammad_Juna_Nasri.pdf" className="btn btn-outline" download>
              <Download size={15} /> Download CV
            </a>
            <a href="mailto:muhammadj.nasri@gmail.com" className="btn btn-ghost">
        ...
        <div className="hero__right anim-4">
          ...
          <div className="hero__stack">
            <p className="hero__stack-label">Primary stack</p>
            <div className="hero__stack-tags">
              {['Laravel', 'React', 'Node.js', 'MySQL', 'Kotlin', 'Python'].map(t => (
